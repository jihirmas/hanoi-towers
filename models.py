...
class MainMenu(ColorConstants):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT):
        ...
        self.btn_return = Button("Return to menu",self.BLACK,30,'Calibri',self.BACKGROUND,200,30)
...
class Game(ColorConstants):
    def __init__(self,SCREEN_WIDTH,SCREEN_HEIGHT):
        ...
        self.btn_reset = Button("Reset", self.BLACK, 30, 'Calibri', self.GREEN, 100, 30)
        self.btn_reset.rect.x = 20
        self.btn_reset.rect.y = 20
